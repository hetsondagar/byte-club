...
export const questsData: Quest[] = [
  {
    ...
    story: `
      In the deepest layers of ByteNet lies the Quantum Vault, storing ancient encryption keys. 
      The vault's guardian challenges intruders with puzzles combining cryptography, probability, and logic. 
      To open it, you must unravel three sequential challenges.
    `,
    ...
    missions: [
      {
        ...
        description: `
          The vault projects a series of qubits: |ψ> = α|0> + β|1>. 
          Identify the most probable measurement outcome given α² = 0.8 and β² = 0.2.
        `,
        challenge: `
      ...
      },
      {
        ...
        description: `
          Two qubits are entangled: measuring one instantly affects the other. 
          If the first qubit is 1, the second is guaranteed 0. 
      ...
      },
      {
        ...
        description: `
          The terminal locks the vault. You must implement a function to **detect cycles in a directed graph**
          representing entangled qubits. The input is an adjacency list. Output true if a cycle exists, false otherwise.
          This will determine if the vault's quantum locks are stable.
        `,
        challenge: `
          >> TERMINAL CHALLENGE: Implement cycle detection in a directed graph (adjacency list input).
  ...
  },
  {
    ...
    story: `
      ByteNet's oldest servers contain algorithmic guardians. 
      Paths shift dynamically based on logical reasoning. Solve the algorithmic trials to navigate the maze.
    `,
    difficulty: "Very Hard",
    xp: 2200,
    ...
    missions: [
      {
        ...
        description: `
          Four guardians appear: which sorting algorithm is stable and efficient for partially sorted data?
        `,
        challenge: `
          >> OPTIONS:
          A) QuickSort
      ...
      },
      {
        ...
        description: `
          The bridge only allows passage through recursive logic. 
          Given T(n) = T(n-1) + n, name the Big-O complexity (one word).
        `,
      ...
      },
      {
        ...
        title: "Maze Terminal",
        description: `
          At the maze's heart, implement **lowest common ancestor in a binary tree**. 
          Input: root node and two values. Output: value of LCA. 
          Only correct code allows you to retrieve the magic key.
        `,
        challenge: `
  ...
  },
  {
    ...
    story: `
      Rogue packets infiltrate ByteNet. Firewalls challenge your mastery over security, exploits, and cryptography.
    `,
    difficulty: "Very Hard",
    xp: 2100,
    ...
    missions: [
      {
        ...
        description: `
          Incoming packet: 'GET /admin HTTP/1.1'. Choose the attack type:
        `,
        challenge: `
          >> OPTIONS:
          A) SQL Injection
      ...
      },
      {
        ...
        title: "Cipher Lock",
        description: `
          One-word answer: symmetric, block-based encryption widely used for legacy data.
        `,
      ...
      },
      {
        ...
        description: `
          Terminal demands code: sanitize user input to prevent SQL Injection. 
          Input: 'userInput'. Output: safe query string.
        `,
        challenge: `
  ...
  },
  {
    ...
    story: `
      Deep in ByteNet lies the Compiler’s Crypt. Solve hidden cycles, control flow puzzles, and optimize memory to extract secrets.
    `,
    difficulty: "Very Hard",
    xp: 2300,
    ...
    missions: [
      {
        ...
        description: `
          Compiler shows infinite loops. Identify which traversal detects cycles:
        `,
        challenge: `
          >> OPTIONS:
          A) BFS
      ...
      },
      {
        ...
        description: `
          Ghost code manipulates jumps. One-word answer: analysis type that tracks execution paths.
        `,
  ...
  },
  {
    ...
    story: `
      The Neural Nexus controls ByteNet AI memory. Solve neural, algorithmic, and coding challenges to pass the sentinel.
    `,
    difficulty: "Very Hard",
    xp: 2500,
    ...
    missions: [
      {
        ...
        description: `
          Neural connections spike across nodes. Choose the **non-linear activation** function used in deep networks:
        `,
        challenge: `
          >> OPTIONS:
          A) ReLU
      ...
      },
      {
        ...
        title: "Backprop Gate",
        description: `
          One-word answer: algorithm used to propagate errors backward through a neural network.
        `,
      ...
      },
      {
        ...
        description: `
          Terminal demands code: implement **Dijkstra's algorithm** to find shortest path from source to all nodes.
        `,
        challenge: `
  ...
  },
  {
    ...
    story: `
      Deep in ByteNet, a forgotten OS still runs hidden processes. The kernel whispers through logs, 
      challenging intruders to solve system puzzles before access is revoked.
    `,
    difficulty: "Very Hard",
    xp: 2000,
    ...
    missions: [
      {
        ...
        description: `
          A rogue process spawns multiple children. Choose the UNIX command that lists running processes:
        `,
        challenge: `
          >> OPTIONS:
          A) ps
      ...
      },
      {
        ...
        description: `
          One-word answer: Data structure used to manage free and allocated memory blocks efficiently.
        `,
      ...
      },
      {
        ...
        description: `
          Terminal challenge: Implement a function that **detects deadlocks** in a resource allocation graph.
          Input: adjacency list of processes/resources. Output: true if deadlock exists, false otherwise.
        `,
        challenge: `
  ...
  },
  {
    ...
    story: `
      A rogue switch redirects packets unpredictably. Only those who understand routing, graphs, 
      and shortest paths can reach the final node and capture the hidden flag.
    `,
    difficulty: "Very Hard",
    xp: 2100,
    ...
    missions: [
      {
        ...
        description: `
          Which algorithm finds the shortest path in weighted graphs without negative edges?
        `,
        challenge: `
          >> OPTIONS:
          A) Bellman-Ford
      ...
      },
      {
        ...
        description: `
          One-word answer: The measure of time for a packet to travel from source to destination.
        `,
  ...
  },
  {
    ...
    story: `
      Deep inside ByteNet, a phantom database constantly shifts schema. 
      Only precise queries, logic, and reasoning can extract the hidden secrets without triggering alarms.
    `,
    difficulty: "Very Hard",
    xp: 2200,
    ...
    missions: [
      {
        ...
        description: `
          Which SQL keyword prevents duplicate rows in a SELECT query?
        `,
        challenge: `
          >> OPTIONS:
          A) UNIQUE
      ...
      },
      {
        ...
        title: "Trigger Guard",
        description: `
          One-word answer: Type of database constraint that automatically executes on insert, update, or delete.
        `,
  ...
  },
  {
    ...
    story: `
      The cache stores time-sensitive secrets. Only by understanding queues, priority, and dynamic updates can you unlock the frozen bytes.
    `,
    difficulty: "Very Hard",
    xp: 2300,
    color: "from-cyan-500 to-blue-700",
    missions: [
      {
        ...
        description: `
          Which data structure ensures first-in-first-out processing?
        `,
        challenge: `
          >> OPTIONS:
          A) Stack
      ...
      },
      {
        ...
        description: `
          One-word answer: Data structure ideal for processing tasks based on priority instead of arrival time.
        `,
        challenge: `>> QUERY: Name the structure`,
        tags: ["ds", "cse-theory"],
        xp: 700,
  ...
  },
  {
    ...
    story: `
      A sentient AI monitors ByteNet's gateway. Solve its reasoning challenges and DSA puzzles to prove your intelligence.
    `,
    difficulty: "Very Hard",
    xp: 2500,
    color: "from-purple-500 to-pink-700",
    missions: [
      {
        ...
        title: "Logic Grid",
        description: `
          AI presents a puzzle: Which logic gate outputs 1 only when inputs are different?
        `,
        challenge: `
          >> OPTIONS:
          A) AND
      ...
      },
      {
        ...
        description: `
          One-word answer: Type of traversal that explores as far as possible along each branch before backtracking.
        `,
